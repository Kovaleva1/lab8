...
public class AddElementController implements Initializable, ModalController {
    ...
    @FXML
    private ChoiceBox<MusicGenre> musicGenresChoice;
    ...
    @FXML
    private Label countPartLabel;
    @FXML
    private TextField countPartField;

    @FXML
    private Label countSingleLabel;

    @FXML
    private TextField countSingleField;
    @FXML
    ...
    @FXML
    private TextField labelSaleField;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        submitButton.setOnAction(event -> {
            ...
            if (wrong.isEmpty()) {
                ...
                addCommand.setUser(CurrentUser.getUser());
                addCommand.setCollectionManager(CurrentCollectionManager.getCollectionManager());
                addCommand.setMusicBand(musicBand);
                addCommand.execute(new String[]{});
                modalStage.close();
            } else {
    ...
    private void setLanguage() {
        ...
        addLabel.setText(currentLanguage.getString("add"));
        ...
        submitButton.setText(currentLanguage.getString("registerButton"));
